<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Stage6.aspx.cs" Inherits="Site.Pages.StaticContent.StepTables.Stage6" MasterPageFile="~/Pages/Site.Master" %>

<asp:Content ID="Stage6Table" ContentPlaceHolderID="Stage6Page" runat="server">
    <style>
        .mydatagrid {
            width: 80%;
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <label>Ущерб млн. рублей</label>
                            <div class="form-group">
                                <asp:TextBox CssClass="form-control" ID="damage" runat="server" />
                            </div>
                            <label>Объект воздействия</label>
                            <div class="form-group">
                                <asp:DropDownList CssClass="form-control" ID="IAType" runat="server" />
                            </div>
                            <label>Уровень последствия</label>
                            <div class="form-group">
                                <asp:TextBox CssClass="form-control" ID="consLevel" runat="server" />
                            </div>
                            <div class="form-group">
